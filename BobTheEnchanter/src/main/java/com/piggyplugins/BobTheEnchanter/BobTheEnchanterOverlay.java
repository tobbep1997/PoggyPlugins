...
public class BobTheEnchanterOverlay extends OverlayPanel {

    private final BobTheEnchanterPlugin plugin;

    @Inject
    private BobTheEnchanterOverlay(BobTheEnchanterPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
