...
public class BobTheEnchanterPlugin extends Plugin {
    ...
    @Inject
    BobTheEnchanterConfig config;
    @Inject
    private KeyManager keyManager;
    @Inject
    private OverlayManager overlayManager;
    @Inject
    private BobTheEnchanterOverlay overlay;
    @Inject
    ...
    @Provides
    private BobTheEnchanterConfig getConfig(ConfigManager configManager) {
        return configManager.getConfig(BobTheEnchanterConfig.class);
    }
