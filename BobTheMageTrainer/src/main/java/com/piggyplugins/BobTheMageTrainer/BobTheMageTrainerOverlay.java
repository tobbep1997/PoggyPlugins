...
public class BobTheMageTrainerOverlay extends OverlayPanel {

    private final BobTheMageTrainerPlugin plugin;

    @Inject
    private BobTheMageTrainerOverlay(BobTheMageTrainerPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
